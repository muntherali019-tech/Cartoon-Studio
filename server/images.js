// Real cartoon image generation. Two ways to wire the best available model:
...
// Returns { url } | { b64 } | null  (null → caller falls back to the built-in
// client-side "Toon Render" so the product still works with no image key).
